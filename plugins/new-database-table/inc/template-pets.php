...
<div class="container container--narrow page-section">
    ...
    <p>This page took <strong><?php echo timer_stop(); ?></strong> seconds to prepare. Found <strong><?php echo number_format( $get_pets->count ); ?></strong> results (showing the first <?php echo count($get_pets->pets); ?>).</p>
    ...
    ?>
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="create-pet-form" method="POST">
            <p>Enter just the name for a new pet. All other details will be randomly generated.</p>
