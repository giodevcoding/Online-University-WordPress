...
/* harmony import */ var _modules_UniNotes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/UniNotes */ "./src/modules/UniNotes.js");
...
const notes = new _modules_UniNotes__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class Like {
  ...
  async addLike(likeBox) {
    ...
    const request = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + '/wp-json/university/v1/manage-like', data).then(response => {
  ...
  async removeLike(likeBox) {
    ...
    const request = await axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](universityData.root_url + '/wp-json/university/v1/manage-like', {
      data: data
    }).then(response => {
                            ...
                            ${results.professors.map(item => `
                                <li class="professor-card__list-item">
                                    <a class="professor-card" href="${item.permalink}">
                                        <img src="${item.imageURL}" alt="" class="professor-card__image">
...
class UniNotes {
  ...
  async deleteNote(e) {
    ...
    const request = await axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](universityData.root_url + '/wp-json/wp/v2/note/' + noteID).then(response => {
      //SUCCESS
  ...
  async saveNote(e) {
    ...
    const request = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + '/wp-json/wp/v2/note/' + noteID, updatedContent).then(response => {
      //SUCCESS
      this.makeNoteReadOnly(noteEl);
  ...
  async createNote() {
    ...
    const request = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + '/wp-json/wp/v2/note/', newNoteContent).then(response => {
      ...
      let finalHeight;
      const newlyCreatedNote = document.querySelector("[data-id='" + response.data.id + "']"); // give the browser 30 milliseconds to have the invisible element added to the DOM before moving on
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UniNotes);
